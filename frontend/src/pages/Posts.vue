      ...
      posts: [
        {
          ...
          content: 'Magnifique coucher de soleil aujourd\'hui ! La nature nous offre toujours des spectacles incroyables 🌅',
          hasImage: true,
          likes: 24,
          comments: 8
        },
        {
          ...
          content: 'Nouveau projet terminé ! Après 3 mois de développement, notre application mobile est enfin en ligne. Merci à toute l\'équipe pour ce travail formidable ! 🚀',
          hasImage: false,
          likes: 42,
          comments: 15
        },
        {
          ...
          content: 'Weekend relaxant au bord de la mer. Parfois il faut savoir déconnecter pour mieux se reconnecter à soi-même 🌊',
          hasImage: true,
          likes: 18,
          comments: 5
        }
